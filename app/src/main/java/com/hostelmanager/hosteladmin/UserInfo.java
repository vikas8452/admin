...
public class UserInfo {
    ...
    String notify,topic,description;
    ...
    public UserInfo(String topic,String description,String x,String y){
        this.topic = topic;
    ...
    public UserInfo(String fname, String mobile1, String email ) {
        this.fname = fname;
        this.mob = mobile1;
        this.email = email;
    }
